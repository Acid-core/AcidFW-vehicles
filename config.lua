...
Config.skillbarTurbo        = "AcidFW-skillbar" 
Config.skillbarXenons       = "AcidFW-skillbar" 
Config.skillbarRemoveTint   = "AcidFW-skillbar"


-- Main 
Config.isVehicleOwned = true                    --  [true or false] checks if the vehicle is owned
